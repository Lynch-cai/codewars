// Small enough?
export function smallEnough(arrayOfNumbers: number[], limit: number): boolean{
  let numbersUnderLimit = true
  arrayOfNumbers.forEach(num => {if (num > limit) numbersUnderLimit = false})
  return numbersUnderLimit
}
