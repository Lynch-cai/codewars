// HTML Generator
function HTMLGen () {
  this.div = (e) => `<div>${e}</div>`
  this.b = (e) => `<b>${e}</b>`
  this.p = (e) => `<p>${e}</p>`
  this.a = (e) => `<a>${e}</a>`
  this.body = (e) => `<body>${e}</body>`
  this.div = (e) => `<div>${e}</div>`
  this.span = (e) => `<span>${e}</span>`
...
//   it ("should generate div elements", function(){
//       Test.expect(htmlGen.div('test') === '<div>test</div>');
//   });
  
//   it ("should generate b elements", function(){
//     Test.expect(htmlGen.b('test') === '<b>test</b>');
//   });
// });